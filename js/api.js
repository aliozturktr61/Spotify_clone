...
//* Inputa girilen veriye göre aratacağımız api'nin keyi.shazam key herkeze özel api keyler
const options = {
	method: 'GET',
	headers: {
...
//* Popüler müzikleri getireceğimiz api key. spotify key herkeze özel api keyler
const optionsTop = {
	method: 'GET',
	headers: {
		'X-RapidAPI-Key': 'df36766df4msh611d2126b0e0dd2p1a7b86jsn19e479662678',
